...
export default function SignInPage() {
  return (
    <div className="grid w-full flex-grow items-center bg-gradient-to-r from-white to-red-600 px-4 sm:justify-center">
      <SignIn.Root>
        <SignIn.Step
          name="start"
          className="w-full flex-grow space-y-6 rounded-2xl bg-gradient-to-r from-gray-200 via-white to-gray-200 px-4 py-10 ring-1 ring-inset ring-gray-300 sm:w-96 sm:px-8 shadow-2xl"
        >
